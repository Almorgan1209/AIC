...
academic_df = pd.read_csv("LatentClasses_academic.csv")
health_df = pd.read_csv("LatentClasses_health.csv")
...
#Compare whether Latent Class Assignments are related between topics.
