...
# Load datasets
health_df = pd.read_csv("health_conjoint_knowledge_removed.csv")
academic_df = pd.read_csv("academic_conjoint_knowledge_removed.csv")
...
merge_and_save_latent_classes(health_df, health_participant_filtered_df, "Health_Completed_df")
merge_and_save_latent_classes(academic_df, academic_participant_filtered_df, "Academic_Completed_df")
